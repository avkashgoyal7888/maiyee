<div>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="myExtraLargeModalLabel">Add Exhibition</h5>
               ...
               <form wire:submit.prevent='store()'>
                  <div class="modal-body">
                     <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-12 mb-3">
                           <label for="nameExLarge" class="form-label">Exhibition Date</label>
                           <input type="date" class="form-control" wire:model='ex_date'>
                           @error('ex_date')<span class="text-danger">{{$message}}</span>@enderror
                        </div>
                     </div>
                  </div>
   ...
   <div wire:ignore.self class="modal" id="delete" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="myLargeModalLabel">Delete Category</h5>
