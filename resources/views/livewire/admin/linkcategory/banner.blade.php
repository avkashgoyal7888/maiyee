<div>
         ...
         <table class="table table-sm table-bordered border-dark mb-0 text-center">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>{{ ucwords($ex->start_date) }}</td>
                  <td>{{ ucwords($ex->end_date) }}</td>
                  <td><img src="{{ $ex->image }}" width="300" height="100" /></td>
                  <td style="font-size: 20px">
                     <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#edit" wire:click="editBanner({{$ex->id}})"><i class="fas fa-pen"></i></button>&nbsp;&nbsp;
                     <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete" wire:click="deleteBanner({{$ex->id}})"><i class="fas fa-trash"></i></button>
                  </td>
               </tr>
               @empty
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="myExtraLargeModalLabel">Add Link-Banner</h5>
               ...
               <form wire:submit.prevent='store()'>
                  <div class="modal-body">
                     <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-12 mb-3">
                           <label for="nameExLarge" class="form-label">End Date</label>
   ...
   <div wire:ignore.self class="modal" id="edit" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="myExtraLargeModalLabel">Edit Banner</h5>
                  ...
                  <div class="modal-body">
                     <div class="row">
                        <div class="col-md-12 col-lg-6 col-sm-12 col-12 mb-3">
                           ...
                           <input type="hidden" wire:model='banr_id'>
                           @error('title')<span class="text-danger">{{$message}}</span>@enderror
                        </div>
                        <div class="col-md-12 col-lg-6 col-sm-12 col-12 mb-3">
                           <label for="nameExLarge" class="form-label">Start Date</label>
