    ...
    <div id="page-content">
        ...
        <div class="container mt-4">
            <div class="row">
               ...
               @foreach($product->where('id', $sizes->product_id) as $products)
                                <div class="col-6 col-sm-6 col-md-4 col-lg-2 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('admin/color/' . $sizes->color->image) }}" src="{{ asset('admin/color/' . $sizes->color->image) }}" alt="image" title="product">
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('admin/color/' . $sizes->color->image) }}" src="{{ asset('admin/color/' . $sizes->color->image) }}" alt="image" title="product">
                                            <!-- End hover image -->
                                            <!-- product label -->
