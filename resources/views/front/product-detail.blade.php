...
@endif
               ...
               <p class="shippingMsg"><i class="fa fa-clock-o" aria-hidden="true"></i> ESTIMATED DELIVERY BETWEEN <br><b id="fromDate" style="margin-left: 25px">{{ $startFormatted }}</b> to <b id="toDate">{{ $endFormatted }}</b>.</p>
