...
@endif
               ...
               <p class="shippingMsg"><i class="fa fa-clock-o" aria-hidden="true"></i> ESTIMATED DELIVERY BETWEEN <br><b id="fromDate" style="margin-left: 30px">{{ $startFormatted }}</b> to <b id="toDate">{{ $endFormatted }}</b>.</p>
                  ...
                  <div class="spr-container">
                     <div class="spr-header clearfix">
                        <div class="spr-summary">
                           ...
                           <i class="font-13 fa fa-star-half-o"></i>
                           @else
                           <i class="font-13 fa fa-star-o" style="font-size: 20px;"></i>
                           @endif
