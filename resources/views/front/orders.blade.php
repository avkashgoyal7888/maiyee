                    ...
                    <div class="row w-100 no-gutters">
                        ...
                        <div class="col-6 col-md">
                            ...
                            <p class="text-pebble mb-0 w-100 mb-2 mb-md-0">
                                {{ date('d-M-y', strtotime($orders->order_date)) }}</p>
                        </div>
                        <div class="col-6 col-md">
                        ...
                        <div class="col-6 col-md">
                            ...
                            <p class="text-pebble mb-0 w-100 mb-2 mb-md-0">{{$orders->address}} {{$orders->landmark}}
                                {{$orders->state}} {{$orders->city}} {{$orders->pin_code}}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="shopify-payment-button" data-shopify="payment-button">
                                ...
                                <button type="button" class="btn-lg btn-success">
                                    <a href="https://shiprocket.co/tracking/{{$orders->order_id}}"
                                        class="text-white">Track Your Order</a>
                                </button>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row no-gutters mt-3 col-12">
                            ...
                            <div class="col-12 col-md-3 hidden-sm-down">
                                ...
                                @endforeach
                                @else
                                <button data-id="{{$od->id}}" data-order="{{$od->order_id}}"
                                    class="btn btn-danger w-100 mb-2 returnOrReplace" title="Remove item">Return
                                    Item</button>
                                @endif
                ...
                <form id="returnOrReplaceSubmit">
                    <div class="modal-body">
                        <div class="col-md-12 col-lg-12 col-xl-12 p-0">
                            <label for="nameExLarge" class="form-label">Return or Replace<span
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 p-0" id="return_payment" style="display:none;">
                            <label for="nameExLarge" class="form-label">Return Payment Details<span
                                    class="required-f">*</span></label>
                            <textarea name="return_payment" class="form-control resize-both input-field"
                                rows="2"></textarea>
                        </div>
