...
<div class="page section-header text-center">
    <div class="page-title">
        <div class="wrapper">
            <h1 class="page-width">Order Cancel</h1>
        </div>
    </div>
</div>
<!--End Page Title-->
<div class="container mt-5 d-flex justify-content-center">
    <div class="order-card p-4 mt-3">
        ...
        <div class="order-detail">
            <span class="d-block order-summery">Your order has been placed. we will deliver your order as soon as
                possible. Your order invoice has been sent to your email.</span>
        </div>
        <hr>
        <div class="text">
            <span class="d-block new mb-1">{{$order->name}}</span>
        </div>
        <span class="d-block address mb-3">{{$order->address}} {{$order->landmark}} {{$order->state}} {{$order->city}}
            {{$order->pin_code}}</span>
