                    ...
                    <tbody>
                        ...
                        <tr class="cart__row border-bottom line1 cart-flex border-top">
                            <td class="cart__image-wrapper cart-flex-item">
                                <a href="#"><img class="cart__image" src="{{$carts->color->image}}"
                            ...
                            <td class="cart__price-wrapper">
                                <div class="cart style2">
                                    <div class="qtyField">
                                        <a class="qtyBtn minus" href="javascript:void(0);" id="minusBtn"
                                            data-id="{{ $carts->id }}"><i class="icon icon-minus"></i></a>
                                        <input type="hidden" name="id" class="cartupdateId" value="{{ $carts->id }}">
                                        <input class="cart__qty-input qty" type="text" name="quantity"
                                            id="qty_{{ $carts->id }}" value="{{ $carts->quantity }}" pattern="[0-9]*">
                                        <a class="qtyBtn plus" href="javascript:void(0);" id="plusBtn"
                                            data-id="{{ $carts->id }}"><i class="icon icon-plus"></i></a>
                                    </div>
                                </div>
                            </td>
                            <td class="cart__price-wrapper">
                                <button data-id="{{$carts->id}}" class="cart__remove deleteCart" title="Remove tem"><i
                                        class="icon icon anm anm-times-l"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="solid-border">
                <div class="row">
                    ...
                    <span class="col-12 col-sm-6 cart__subtotal-title cart__subtotal text-right"><span
                            class="money">₹{{$cartTotal}}</span></span>
                </div>
                ...
                <a href="{{route('web.checkout')}}" name="checkout" id="cartCheckout" class="btn btn--small-wide block"
                    value="Checkout">CheckOut</a>
                <div class="paymnet-img"><img src="{{asset('front/assets/images/payment-img.jpg')}}" alt="Payment">
                </div>
            </div>
        </div>
    </div>
